...
import kr.co.kosmo.project_back.user.dto.RegisterResponseDto;
...
public class RegisterController {
   ...
   @PostMapping("/register")
    public ResponseEntity<?> register(@Valid @RequestBody SignUpDto dto, HttpServletRequest request) {    // JSON -> DTO로 바꿔서 넣음(바인딩)
        try {
